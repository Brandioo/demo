...
import com.intelycare.testConfiguration;
...
public class RenderCommand extends ConfiguredCommand<testConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<testConfiguration> bootstrap,
                       Namespace namespace,
